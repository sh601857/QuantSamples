...
#def GetHKQuote(ticker):
    ...
    #try:
        ...
        #return (ticker, latest_Q_Item['name'] , float( latest_Q_Item['current'] ), float( latest_Q_Item['time'] ) )  
    #except:        
        #return None
    
    
#print( GetHKQuote('02601') )

import urllib.request
from urllib.parse import urlencode

URL_ROOT = r'https://xueqiu.com/v4/stock/quote.json?code=02601'
