...
# wb = xw.Book(r'C:\Users\SFF\Documents\table.xls')
# sht = wb.sheets['table']
...
'A733917349':'HTSWP','0221666359':'HTSWP','A733919236':'JAXHT','0221666518':'JAXHT'}

rec = pd.read_csv(r'C:\Users\SFF\Documents\table.xls',sep='\t',header=0, index_col=None, dtype={u'股东帐户':str,u'证券代码':str}, encoding='gbk',
...
rec.to_csv(r'C:\Users\SFF\Documents\table.xls', sep=',', index=False, encoding='gbk')
print(rec)